...
Project template for a Drupal static site generated by [Quick](https://github.com/Drupal-Quick/drupal-quick). It pre-wires Drupal core, Quick (+ the starterkit theme), Drush, and
